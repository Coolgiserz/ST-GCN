...
parser.add_argument('--checkpoint',type=str,default='checkpoints/metr_exp1_best_3.36.pth', help='')
...
def main():
    ...
    if args.plotheatmap == "True":
        adp = F.softmax(F.relu(torch.mm(model.nodevec1, model.nodevec2)), dim=1) # nodevec1 attribute is None when gcn_bool and addadj are False
